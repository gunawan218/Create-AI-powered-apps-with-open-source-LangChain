...
openai_api_key = "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"
...
gr.Interface(fn=generate_cover_letter, inputs=inputs, outputs=output).launch(server_name="0.0.0.0", server_port= 7869, share=True)